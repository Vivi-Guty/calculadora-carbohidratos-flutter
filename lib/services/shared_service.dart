...
class SharedService {
  ...
  GelMixImpl gelCalculator(
    ...
    double proteinForGel = nameDropdown ==
            LocalizationService.of(context).translate('ratio', '1:0,8Protein')
        ? (maltodextrinForGel + fructoseForGel) / 3.5
        : 0;
    ...
    water = int.parse((((maltodextrinForGel +
                    fructoseForGel +
                    proteinForGel +
                    flavorings +
                    salts) *
    ...
    return GelMixImpl(
      ...
      gramsProtein:
          double.parse((proteinForGel * numberGels).toStringAsFixed(2)),
